...
public class MyCameraView extends CameraBridgeViewBase implements PreviewCallback {
        ...
        synchronized (this) {
            ...
            try {
                ...
                if (sizes != null) {
                    ...
                    org.opencv.core.Size frameSize = calculateCameraFrameSize(sizes, new MyCameraView.JavaCameraSizeAccessor(), width, height);
    ...
    protected boolean connectCamera(int width, int height) {
        ...
        mStopThread = false;
        mThread = new Thread(new MyCameraView.CameraWorker());
        mThread.start();
    ...
    public void onPreviewFrame(byte[] frame, Camera arg1) {
        if (org.opencv.BuildConfig.DEBUG)
