...
public class LineDS {
    ...
    Line top, bottom, left, right; // lines at extremeties
    Line hor1, hor2, hor3; // horizontal dividing lines for answers
    Line ver1, ver2, ver3; // vertical dividing lines for answers
